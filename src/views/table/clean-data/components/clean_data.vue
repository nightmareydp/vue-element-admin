<template>
  <div class="components-container" style="margin-top: 30px">
    <el-row>
      <!-- 全量洗数 -->
      <el-button type="warning" icon="el-icon-s-open" :loading="loadingStatusAllData" @click="cleanAllData">{{ loadingButtonAllData }}</el-button>
      <!-- 手动洗数 -->
      <el-button type="primary" icon="el-icon-brush" :loading="loadingStatusToLastTimeData" @click="cleanToLastTimeData">{{ loadingButtonToLastTimeData }}</el-button>
      <!-- 自定义时间洗数 -->
      <el-button type="primary" icon="el-icon-date" :loading="loadingStatusSetupTimeData" @click="centerDialogVisible = true">{{ loadingButtonSetupTimeData }}</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      reportSourceList: [],
      eventTypeList: [],
      systemProductListLength: 0,
      dspatchLevelListLength: '0',
      slaListLength: '',
      reportSourceListLength: '',
      eventTypeListLength: '',
      mapTest: { }
    }
  },
