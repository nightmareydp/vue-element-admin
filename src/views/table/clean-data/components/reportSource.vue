<template>
  <div>
    <div>
      <h4 style="text-align: center">《报告来源》</h4>
    </div>
    <!-- 表格主体-->
    <el-table
...
export default {
  ...
  methods: {
    ...
    getReportSourceAllData() {
      ...
      this.list = []
      this.data = []
      fetch.get({ url: '/no/getReportSourceAllData' }, res => {
        console.log(res)
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        ...
        // this.listLoading = true
        fetch.get({ url: '/no/setReportSourceNewData?reportSource=' + this.temp.reportSource +
